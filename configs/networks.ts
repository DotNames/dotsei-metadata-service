...
const Shardeum =
  "https://res.cloudinary.com/sushi-cdn/image/fetch/w_64,f_auto,q_auto,fl_sanitize/https://raw.githubusercontent.com/vanshtah/logos/main/Shardeum%20Logo%20Icon%20Light%20-%20Square.png";
...
export const NETWORK_ICON = {
  ...
  [ChainId.FUSE]: Fuse,
  [ChainId.TELOS]: Telos,
  [ChainId.LIBERTY15]: Shardeum,
  [ChainId.LIBERTY20]: Shardeum,
};
...
export const NETWORK_LABEL: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.LIBERTY15]: "Shardeum Liberty 1.5",
  [ChainId.LIBERTY20]: "Shardeum Liberty 2.0",
};
